 ...
 */
public class GenerateAutoDestroy extends AbsGenerator {
    @Override
    ...
    protected void onLooping(InjectionElement injectionElement, JavaStringBuilder builder) {
        builder.appendSpace(2).append("target.registerDestroyable(target.").append(injectionElement.elementName).append(");\n");
    }
}