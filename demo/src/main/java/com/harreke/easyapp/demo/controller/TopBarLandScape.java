 ...
 */
public abstract class TopBarLandScape extends ControllerWidget {
    @InjectView
    View top_bar_back;
    @InjectView
    ...
    public TopBarLandScape(@NonNull ControllerLayout controllerLayout) {
        super(controllerLayout, R.layout.controller_top_bar_landscape);
    }

    @InjectClick
    protected abstract void top_bar_back();

    @InjectClick
    protected abstract void top_bar_setting();
}