...
public class SizableDrawableTextView extends AppCompatTextView {
    ...
    public SizableDrawableTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray style = context.obtainStyledAttributes(attrs, R.styleable.SizableDrawableTextView);
        ...
        mCenteringDrawable = style.getBoolean(R.styleable.SizableDrawableTextView_centeringDrawable, false);
        style.recycle();
