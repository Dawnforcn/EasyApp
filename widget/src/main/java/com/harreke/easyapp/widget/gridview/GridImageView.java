package com.harreke.easyapp.widget.gridview;
...
import com.harreke.easyapp.util.MathUtil;
import com.harreke.easyapp.util.MetricUtil;
import com.harreke.easyapp.widget.R;
import com.harreke.easyapp.widget.autofitview.AutoFitImageView;
...
public class GridImageView extends AutoFitImageView {
    ...
    private int mRowMax;
    private float mThreshold = MetricUtil.TouchSlop;
    private int mWidth;
    ...
    public GridImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray style = context.obtainStyledAttributes(attrs, R.styleable.GridImageView);
        ...
        mRowDividerWidth = (int) style.getDimension(R.styleable.GridImageView_grid_row_divider_width, MetricUtil.Density);
        ...
        mLineDividerHeight = (int) style.getDimension(R.styleable.GridImageView_grid_line_divider_height, MetricUtil.Density);
    ...
    public interface OnGridClickListener {
        void onGridClick(int row, int line);
    }
}