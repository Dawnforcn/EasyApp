...
public class StringUtil {
    ...
    public static int hashCode(@Nullable String string, int defaultHashCode) {
    ...
    public static int hashCode(@Nullable String string) {
        return hashCode(string, 0);
    }

    public static String indentNumber(long number) {
        String result;
    ...
    public static boolean isEmpty(String str1, String str2) {
        return null == str1 || null == str2 || str1.trim().length() == 0 || str2.trim().length() == 0;
    }
