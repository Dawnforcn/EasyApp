...
public class FileUtil {
    public static boolean copyFile(@NonNull File source, @NonNull File target) {
        ...
        if (source.exists() && source.isFile()) {
            try {
                ...
                success = false;
                Logger.e("Copy file " + source.getAbsolutePath() + " to " + target.getAbsolutePath() + " error!");
            }
        }
    ...
    public static boolean copyFile(InputStream inputStream, FileOutputStream fileOutputStream) {
        ...
        if (inputStream != null && fileOutputStream != null) {
            try {
                ...
                success = false;
                Logger.e("Copy file stream error!");
            }
        }
    ...
    public static String readTxt(@NonNull File file) {
        ...
        if (file.exists() && file.isFile()) {
            try {
                ...
                content = null;
                Logger.e("Read txt file " + file.getAbsolutePath() + " error!");
            }
        }
    ...
    public static boolean writeBitmap(@NonNull File file, @NonNull Bitmap bitmap) {
        ...
        try {
            ...
            success = false;
            Logger.e("Write bitmap " + file.getAbsolutePath() + " error!");
        }
    ...
    //        } catch (IOException e) {
    //            success = false;
    //            Logger.e( "Write drawable " + file.getAbsolutePath() + " error!");
    //        }
    //
    //        return success;
    //    }
    ...
    public static boolean writeTxt(@NonNull File file, @NonNull String content) {
        ...
        try {
            ...
            success = false;
            Logger.e("Write file " + file.getAbsolutePath() + " error!");
        }
